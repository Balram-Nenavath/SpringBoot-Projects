...
public class BiFunctionalFI implements BiFunction<List<Integer>, List<Integer>, List<Integer>> {
    @Override
    ...
    public static void main(String[] args) {
        BiFunction biFunction = new BiFunctionalFI();
		...
		/*
		 * sort() sorts the list and replaces the original list, whereas sorted(list)
		 * returns a sorted copy of the list, without changing the original list.
		 */
        //FUnctional Interface< Single Argument example>
